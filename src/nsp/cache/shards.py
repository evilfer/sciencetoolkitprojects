""" from: https://developers.google.com/appengine/articles/sharding_counters """
...
class GeneralCounterShardConfig(ndb.Model):
    ...
    def all_keys(cls, name):
        ...
        return [ndb.Key(GeneralCounterShardConfig, shard_key_string) for shard_key_string in shard_key_strings]
    ...
    if total is None:
        ...
        for counter in ndb.get_multi(all_keys):
            if counter is not None:
                total += counter.count
        memcache.add(name, total, time=86400)
